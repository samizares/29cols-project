...
<div class="wrapper">
                    ...
                    <div class="">
                        <ul class="nav navbar-nav navbar-left">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="user-profile-page.html">Talent Profile page</a></li>
                            </ul>
                            </li>  
                        </ul>
                    </div>
                            ...
                            <li class="btn-group">
                                ...
                                <i class="fa fa-user fa-fw centered"></i></button>
                                    <ul class="list-unstyled dropdown-menu" role="menu">
                                        <li><a href="register-page.html"><button class="btn btn-default btn-xs btn-block" type="button">Register</button></a></li>
                                        <li><a href="login-page.html"><button class="btn btn-default btn-xs btn-block" type="button">Sign in</button></a></li>
                                    </ul>
                            </li>
                        </ul>
            </div>
    ...
    <div class="breadcrumbs">
        <div class="container">
            <h1 class="pull-left">Post Page</h1>
            <ul class="pull-right list-inline">
                <li><a href="index.html">Home </a> &nbsp;|</li>
                <li><a href="talents.html">Songs </a> &nbsp;|</li>
                <li>Post Page</li>
            </ul>
        </div>
    </div>
        ...
        <div class="container"> 
            ...
            <div class="row main-content">                
                ...
                <section class="col-md-7 center-block">
                    ...
                    <h2 class="pull-left red"> Ajaa - Anuofia <span class="small">(Produced by Chopstix)</span></h2>
                    </div>
                    ...
                    <div class="">
                        <section class="row border-bttm">
                            <ul class="col-md-4 list-inline">
                                <li class="thumbnail"><img class="albumart" src="img/bg1-thumbnail.jpg"></li> 
                                <!-- SONG TITLE & ARTIST -->
                                <li class="">
                                    <ul class="list-unstyled">
                                        <li><span class="pp-title1">Anuofia</span></li>
                                        <li><span class="pp-title2"><a class="red" href="user-profile-page.html" target="_blank">Ajaa</a></span></li>
                                    </ul>
                                </li>
                            </ul>
